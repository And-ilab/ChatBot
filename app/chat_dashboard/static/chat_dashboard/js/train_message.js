...
//    const notifyUser = document.querySelector("#notify-user")
...
document.addEventListener('DOMContentLoaded', async function () {
    ...
    // Обработчик для кнопки "Вопрос дообучен"
    // Важно: убедитесь, что кнопке в шаблоне установлен data-атрибут data-message-id (например, data-message-id="{{ message.id }}")
