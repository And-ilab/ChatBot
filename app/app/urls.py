...
urlpatterns = [
                  ...
                  path('api/filter_dialogs_by_date_range/', dashboard_views.filter_dialogs_by_date_range,
                       name='filter_dialogs_by_date_range'),
                  ...
                  path('api/toggle_ignore/<int:message_id>/', dashboard_views.toggle_ignore_message,
                       name='toggle_ignore'),
                  ...
                  path('api/get-nodes-by-type-with-relation/', chat_views.get_nodes_by_type_with_relation,
                       name='get_nodes_by_type_with_relation'),
                  ...
                  path('api/create-training-message/', dashboard_views.create_training_message,
                       name='create_training_message'),
